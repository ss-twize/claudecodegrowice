  ...
  if (active && payload && payload.length) {
    return (
      <div className="bg-[#141E2B] border border-[#223444] rounded-lg p-3 text-sm">
        ...
        <p className="text-[#8299B4]">{payload[1]?.value} записей</p>
      </div>
    );
  }
  return null;
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="bg-[#0F1622] border border-[#223444] rounded-xl p-5">
          ...
          <div className="mt-5 pt-4 border-t border-[#223444] flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <p className="text-[#5E7488] text-xs mt-0.5">Маржа: {Math.round((profitPL / totalRevPL) * 100)}%</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#0F1622] border border-[#223444] rounded-xl p-5">
          <div className="mb-5">
            ...
            <p className="text-[#5E7488] text-sm">Разбивка за текущий месяц</p>
          </div>
