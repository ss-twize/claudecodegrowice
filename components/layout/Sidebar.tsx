  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-60 bg-[#111318] border-r border-[#30363d] flex flex-col z-50">
      ...
      <div className="flex items-center gap-3 px-6 py-5 border-b border-[#30363d]">
        <div className="w-8 h-8 rounded-lg bg-[#00E378] flex items-center justify-center">
          <Scissors size={16} className="text-black" />
        </div>
        <span className="text-[#e6edf3] font-bold text-xl tracking-tight">
          GROW<span className="text-[#00E378]">ICE</span>
        </span>
      </div>
              ...
              <li key={item.href}>
                <Link
                  ...
                  className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-150 ${
                    isActive
                      ? "bg-[#00E378]/10 text-[#00E378] border border-[#00E378]/20"
                      : "text-[#9198a1] hover:text-[#e6edf3] hover:bg-[#1c2128]"
                  }`}
                >
                  <Icon
                    size={18}
                    className={isActive ? "text-[#00E378]" : ""}
                  />
                  {item.label}
                </Link>
              </li>
      ...
      <div className="px-4 py-4 border-t border-[#30363d]">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-full bg-[#00E378]/20 border border-[#00E378]/30 flex items-center justify-center">
            <span className="text-[#00E378] text-xs font-bold">А</span>
          </div>
