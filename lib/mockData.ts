...
export const pricingPlans = [
  {
    ...
    price: 20000,
    priceSuffix: "/мес",
    description: "Система сама обработает всех клиентов: подскажет и запишет. Никакого игнора",
    features: ["ИИ-Администратор (Мессенджеры)", "Маркетинговые системы", "Поддержка 24/7", "Отчеты"],
  },
  {
    id: "scaling",
    name: "Масштабирование (Для сетей)",
    price: 15000,
    priceSuffix: "/мес за филиал",
    popular: true,
    description: "Идеальное решение для владельцев сетевого бизнеса услуг. Все данные в единой системе",
    features: ["ИИ-Администратор (Мессенджеры и Звонки)", "Маркетинговые системы", "Поддержка 24/7", "Отчеты"],
  },
  {
    id: "growth",
    name: "Развитие",
    ...
    customPrice: "X₽",
    priceSuffix: "/мес",
    description: "ИИ-Администратор, который обрабатывает клиентов в мессенджерах и по телефону (прямо как настоящий человек)",
    features: ["ИИ-Администратор", "Маркетинговые системы", "Поддержка 24/7", "Отчеты"],
  },
];
